...
! function(e, t) {
    ...
    var p = {
        ...
        M = {
            ...
            hide: function() {
                this.shown && (this.trigger("hide.datepicker").isDefaultPrevented() || (this.shown = !1, this.$picker.addClass(y).off(g, this.click), this.inline || (C.off("resize.datepicker", this.onResize), $.off(g, this.onGlobalClick), $.off("keyup.datepicker", this.onGlobalKeyup))))
            },
            toggle: function() {
        ...
        T = window.document,
        V = e(T),
        I = ["datepicker-top-left", "datepicker-top-right", "datepicker-bottom-left", "datepicker-bottom-right"].join(" "),
        N = function() {
            function t(i) {
            ...
            return Y(t, [{
                ...
                value: function() {
                    if (!this.inline) {
                        ...
                        w(c) && (c = 10), u > o && u + r + o > s ? (u -= o + c, p = "datepicker-bottom-left") : u += r + c, d + h > a && (d += n - h, p = p.replace("left", "right")), i.removeClass(I).addClass(p).css({
                            top: u,
                            left: d,
    ...
    e.fn.datepicker = function(t) {
        ...
        return this.each(function() {
            ...
            if (!s) {
                ...
                s = new N(this, r), i.data("datepicker", s)
            }
            if ("string" == typeof t) {
                var h = s[t];
    ...
    }, e.fn.datepicker.Constructor = N, e.fn.datepicker.languages = v, e.fn.datepicker.setDefaults = N.setDefaults, e.fn.datepicker.noConflict = function() {
